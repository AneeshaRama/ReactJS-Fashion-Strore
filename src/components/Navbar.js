...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex items-center justify-between h-20 shadow-sm">
        <div className="ml-5">
          <h1 className="text-5xl font-bold logo text-pink-700 cursor-pointer tracking-wider">
            Orchid
          </h1>
        </div>
        <div className="flex list-none items-center space-x-6 mr-5 text-pink-500 font-semibold">
          {isMatch ? (
            <>
              <Drawer
                open={openDrawer}
                onClose={() => setOpenDraer(false)}
                anchor="top"
              >
                <div className="bg-pink-50 flex flex-col items-center">
                  <div className="flex items-center mt-10 space-x-10 text-pink-500">
                    <div>
                      <Home />
                    </div>
                  ...
                  <div className="flex items-center mt-20 mb-5 space-x-5 text-pink-500">
                    <div>
                      <Avatar>A</Avatar>
                    </div>
          ...
          {isMatch && (
            <Menu
              ...
              onClick={() => setOpenDraer(!openDrawer)}
            />
          )}
        </div>
      </nav>
